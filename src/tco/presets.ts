...
export const PRESETS: Preset[] = [
  {
    ...
    overrides: {
      ...
      "bev.taraBaseT": 11.8,
      "gas.taraBaseT": 12.5,
      // Longo curso a gás pede GNL: mais energia embarcada por quilo de
      // sistema, ao custo da evaporação diária.
      "gas.armazenamento": "GNL",
      "gas.capacidadeKg": 400,
      "gas.massaSistemaKgPorKg": 2.6,
      "gas.perdasBoilOffPctDia": 0.3,
  ...
  },
  {
    ...
    overrides: {
      ...
      "h2.modoSuprimento": "B",
      "h2.capacidadeH2Kg": 70,
      "gas.capacidadeKg": 190,
      "gas.pctMarchaLenta": 20,
      "gas.bioModoSuprimento": "B",
